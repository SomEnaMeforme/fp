...
namespace TagsCloudVisualization
{
    internal class CloudCompressor
    {
        ...
        public Result<Rectangle> CompressCloudAfterInsertion(Rectangle forInsertion)
        {
            ...
            return beforeIntersection.AsResult();
        }


        private Result<int> GetDistanceForMoving(Rectangle forMoving, Direction toCompressionPoint)
        {
            var nearest = BruteForceNearestFinder.FindNearestByDirection(forMoving, toCompressionPoint, cloud);
            if (nearest == null) return Result.Fail<int>("Rectangle hasn't the nearest rectangle");
